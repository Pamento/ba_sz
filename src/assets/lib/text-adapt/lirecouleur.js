/**
 * Created by limone-m on 05/08/16.
 */
    ...
    if (typeof(muet) === "undefined") {
        this.phonemes.forEach(function(element, index, array) {
            if (element.estPhonemeMuet()) {
                ...
                em.setAttribute("class", "_aidodys_l_muettes");
 ...
 * Décodage d'un mot sous la forme d'une suite de phonèmes
 */
LireCouleurEngine.prototype.extraireSyllabes = function(phonemes, std_aidodys, oral_ecrit) {
    var i, j, k;
    var phon, phon1, phon2;

    if (typeof(std_aidodys) === "undefined") {
        std_aidodys = 'std';
    }
